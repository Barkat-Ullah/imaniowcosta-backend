...
const careGiver = catchAsync(async (req, res) => {
  const result = await AuthServices.createCareGiverInDb(req);

  sendResponse(res, {
    statusCode: httpStatus.CREATED,
    message: 'Care giver Created Successfully please check his/her mail',
    data: result,
  });
});
